...
public class RecentDataSource {
	  ...
	  public Job addRecent(String jobTitle, String company, String location, String snippet, String url, Long datetime) {
		    ...
		    long insertId = database.insert(MySQLiteHelper.TABLE_RECENT, null,
		        values);
		    Cursor cursor = database.query(MySQLiteHelper.TABLE_RECENT,
	  ...
	  public void deleteJob(Job job) {
		    ...
		    database.delete(MySQLiteHelper.TABLE_RECENT, MySQLiteHelper.COLUMN_ID
		        + " = " + id, null);
		  }
