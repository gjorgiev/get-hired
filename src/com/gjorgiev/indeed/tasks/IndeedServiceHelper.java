...
public class IndeedServiceHelper {
	private static final String webUrl = "http://api.indeed.com/ads/apisearch?publisher=588151988250908&v=2&format=json&sort=date&limit=30";
